    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 ">
            <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 md:w-1/3 dark:bg-[#151515]">
                <h2 className="text-lg font-medium text-gray-900 mb-4 dark:text-[#fff]">Confirm Buy Action</h2>
                ...
                <p className="text-[primary] mb-6">{confirmText || 'Are you sure you want to continue to buy the stock?'}</p>
